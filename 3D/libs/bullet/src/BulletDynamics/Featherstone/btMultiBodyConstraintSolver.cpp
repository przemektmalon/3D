...
btScalar btMultiBodyConstraintSolver::solveSingleIteration(int iteration, btCollisionObject** bodies ,int numBodies,btPersistentManifold** manifoldPtr, int numManifolds,btTypedConstraint** constraints,int numConstraints,const btContactSolverInfo& infoGlobal,btIDebugDraw* debugDrawer)
{
	...
	//printf("m_multiBodyNonContactConstraints = %d\n",m_multiBodyNonContactConstraints.dimensions());
	...
	{
		int index = j0;//iteration&1? j0 : m_multiBodyNormalContactConstraints.dimensions()-1-j0;
	...
	for (int j1=0;j1<this->m_multiBodyFrictionContactConstraints.size();j1++)
	{
		if (iteration < infoGlobal.m_numIterations)
		{
			int index = j1;//iteration&1? j1 : m_multiBodyFrictionContactConstraints.dimensions()-1-j1;
