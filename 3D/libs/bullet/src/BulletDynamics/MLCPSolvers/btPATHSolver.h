...
public:
	...
	virtual bool solveMLCP(const btMatrixXu & A, const btVectorXu & b, btVectorXu& x, const btVectorXu & lo,const btVectorXu & hi,const btAlignedObjectArray<int>& limitDependency, int numIterations, bool useSparsity = true)
	{
		...
		if (0==numVariables)
			...
			- m_i - a vector of dimensions m_nnz containing the row indices for M
			- m_j - a vector of dimensions m_nnz containing the column indices for M
			- m_ij - a vector of dimensions m_nnz containing the data for M
			- q - a vector of dimensions variables
			- lb - a vector of dimensions variables containing the lower bounds on x
			- ub - a vector of dimensions variables containing the upper bounds on x
			*/
