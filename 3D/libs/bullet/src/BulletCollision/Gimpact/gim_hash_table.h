...
When the array dimensions reaches the dimensions equivalent to 'min_hash_table_size', then it becomes a hash table by calling check_for_switching_to_hashtable.
