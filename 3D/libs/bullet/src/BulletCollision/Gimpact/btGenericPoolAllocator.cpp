...
size_t btGenericMemoryPool::allocate_from_free_nodes(size_t num_elements)
{
	...
	// find an avaliable free node with the correct dimensions
	...
	// post: finalsize>=0, m_allocated_sizes[ptr] has the requested dimensions
...
/*!
\param size_bytes dimensions in bytes of the buffer
*/
